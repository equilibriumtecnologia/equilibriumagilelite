      ...
      <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center justify-between gap-3 sm:gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <h2 className="text-base sm:text-lg font-semibold">{sprint.name}</h2>
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-6">
          <div className="text-center">
            <p className="text-lg sm:text-2xl font-bold">{completedTaskCount}/{taskCount}</p>
            <p className="text-[10px] sm:text-xs text-muted-foreground">Tarefas</p>
          </div>

          <div className="text-center">
            <p className="text-lg sm:text-2xl font-bold">{completedPoints}/{totalPoints}</p>
            <p className="text-[10px] sm:text-xs text-muted-foreground">Story Points</p>
          </div>

          <div className="text-center">
            <p className={`text-lg sm:text-2xl font-bold ${isOverdue ? "text-destructive" : ""}`}>
