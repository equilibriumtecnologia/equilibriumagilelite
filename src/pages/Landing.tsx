...
const features = [
  {
    ...
    description:
      "Métricas em tempo real com cards de status, projetos recentes, tarefas próximas e relatórios visuais.",
  },
  {
    icon: FolderKanban,
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto leading-relaxed">
                Kanban, sprints, backlog, workspaces e relatórios avançados. Tudo que sua equipe precisa em uma única
                plataforma.
              </p>
            ...
            <div className="relative mt-16 sm:mt-20 max-w-5xl mx-auto">
              ...
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-2xl border border-border">
                <img
                  src={heroImage}
                  alt="Agile Lite Equilibrium - Dashboard com Kanban, Sprints e Relatórios"
        ...
        <section className="py-16 sm:py-24">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold mb-4">Tudo que sua equipe precisa</h2>
              ...
              {[
                {
                  ...
                  desc: "Configure seu espaço de trabalho e convide sua equipe em segundos.",
                },
                {
                  step: "02",
                  title: "Organize Projetos",
                  desc: "Crie projetos, defina sprints e popule o backlog com suas tarefas.",
                },
                {
                  step: "03",
                  title: "Acompanhe Resultados",
                  desc: "Use o Kanban, relatórios e métricas para acompanhar o progresso.",
                },
              ].map((item, i) => (
        ...
        <section className="py-16 sm:py-24 bg-gradient-hero relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-3xl mx-auto text-center text-white">
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Comece a organizar seus projetos hoje</h2>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-4">
              ...
              <p className="text-muted-foreground text-xs sm:text-sm text-center">
                &copy; {new Date().getFullYear()} Agile Lite Equilibrium. Todos os direitos reservados.
              </p>
            </div>
            <PoweredByEquilibrium variant="footer" showTextFallback={false} className="justify-center" />
          </div>
        </div>
      </footer>
    </div>
